...
| **Admin** | Configure system rules, manage users and geofences, oversee ML model schedules |
...
### Face Recognition
Verifies employee identity at check-in using facial embeddings. Enrollment is completed once during onboarding; subsequent check-ins are verified in real time.
...
- [System Requirements](./system-requirements.md) — Check device and network prerequisites before getting started.
- [Quick Start Guide](./quick-start-guide.md) — Complete your first check-in in five steps.
- [Employee User Guide](../user-guides/employee-user-guide.md) — Full guide to using the system as an employee.