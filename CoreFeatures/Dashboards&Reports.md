...
- Content: Date, employee name, status, login time, logout time, work hours.
...
- Scope: Team or individual.
- Content: Performance scores, score components (attendance rate, work hours, idle time), 30-day trend.
